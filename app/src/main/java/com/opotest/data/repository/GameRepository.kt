...
class GameRepository(private val context: Context) {
    ...
    fun startTrainingCustom(category: String, count: Int): TestData {
        ...
        val questions = selected.mapIndexed { i, wq ->
            com.opotest.data.model.Question(
        ...
        val answers = selected.mapIndexed { i, wq ->
            com.opotest.data.model.Answer(id = i + 1, correct = wq.correct)
        }
        return TestData(
            test = com.opotest.data.model.Test(id = "training", name = "Entrenamiento", category = category),
